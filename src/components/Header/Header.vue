...
<template>
  <div class="header-view">
    <div class="header-container">
      <!-- icon图标 -->
      <div style="margin-left: 120px;margin-right: 60px;">
        <img src="@/assets/img/logo.png" alt="logo" style="width: 80px;border-radius: 5px;">
      </div>
      <!-- 导航栏 -->
...
.header-view {
  ...
  z-index: 2000;
  width: 100%;
  background-color: rgba(53, 58, 64, 0.75);
  border-style: none;
